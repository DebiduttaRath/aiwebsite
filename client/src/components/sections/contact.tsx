      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Ready to turn your AI idea into <span className="gradient-text">impact?</span>
          </h2>
        ...
        <div className="max-w-2xl mx-auto">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="bg-white/20 border-white/30 text-white placeholder-slate-300 focus:ring-blue-500 focus:border-transparent"
                        />
                      </FormControl>
              ...
              <div className="mb-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white">Project Brief</FormLabel>
                      <FormControl>
                        <Textarea
                          {...field}
                          rows={4}
                          placeholder="Tell us about your AI project..."
                          className="bg-white/20 border-white/30 text-white placeholder-slate-300 focus:ring-blue-500 focus:border-transparent resize-none"
                        />
                      </FormControl>
                      <FormMessage className="text-red-300" />
                    </FormItem>
